package com.xw.lib_common.proxy.utils;

import android.content.Context;
import android.util.Log;

import com.xw.lib_common.proxy.db.CacheFileInfoDao;
...
public class ProxyFileUtils {
    ...
    static ProxyFileUtils getInstance(Context context, URI uri, boolean isUseByMediaPlayer) {
        // 如果文件名有错误，返回空Utils
